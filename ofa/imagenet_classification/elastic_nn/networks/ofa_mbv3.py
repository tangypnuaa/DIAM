...
class OFAMobileNetV3(MobileNetV3):
    ...
    def get_logits_and_pred(self, x):
        # first conv
        x = self.first_conv(x)
        # first block
        x = self.blocks[0](x)
    ...
    def load_state_dict(self, state_dict, **kwargs):
        ignore_missing = kwargs.pop('strict', True)
        ...
        super(OFAMobileNetV3, self).load_state_dict(model_dict, strict=ignore_missing)
